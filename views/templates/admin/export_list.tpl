...
<div class="elegantalBootstrapWrapper">
    <div class="panel">
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th>
                                    ID
                                    <a href="{$adminUrl|escape:'html':'UTF-8'}&event=exportList&orderBy=id_elegantaleasyimport_export&orderType=desc"><i class="icon-caret-down"></i></a>
                                    <a href="{$adminUrl|escape:'html':'UTF-8'}&event=exportList&orderBy=id_elegantaleasyimport_export&orderType=asc"><i class="icon-caret-up"></i></a>
                                </th>
                                <th>
                        ...
                        <tbody>
                            {foreach from=$models item=model}
                                <tr>
                                    <td>
                                        {$model.id_elegantaleasyimport_export|intval}
                                    </td>
                                    <td>
        ...
        <div class="panel-footer clearfix">
            <div class="btn-group btn_group_primary pull-right">
                <button type="button" class="btn btn-primary btn-lg dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="process-icon-upload"></i> {l s='New Export' mod='elegantaleasyimport'} <span class="caret"></span>
                </button>
                <ul class="dropdown-menu dropdown-menu-right">
                    <li>
                        <a href="{$adminUrl|escape:'html':'UTF-8'}&event=exportEdit&export_entity=product">
                            {l s='Export products' mod='elegantaleasyimport'}
                        </a>
                    </li>
                    <li>
                        <a href="{$adminUrl|escape:'html':'UTF-8'}&event=exportEdit&export_entity=combination">
                            {l s='Export combinations' mod='elegantaleasyimport'}
                        </a>
                    </li>
                </ul>
            </div>
